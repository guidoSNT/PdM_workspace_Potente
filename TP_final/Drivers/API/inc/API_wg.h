...
#define INIT_FMCLK_MHZ      25U     //! First value for the FMCLK
#define INIT_FREQ_DHZ       10000U  //! 1000 Hz
#define INIT_PHASE_DHZ      0U      //! 0 rads
#define ONE_OFFSET          1U      //! For all the offsets in the string manipulation
#define ZERO_CHAR           '0'
#define NINE_CHAR           '9'
#define DOT_CHAR            '.'
#define DECIMAL_BASE        10U     //! When doing division to get digits
#define ADC_PHASE_THRESHOLD 100U    //! If too low the refresh is to fast
#define FSM_BUFFER_LEN      100U    //! The buffer where the msg is written
