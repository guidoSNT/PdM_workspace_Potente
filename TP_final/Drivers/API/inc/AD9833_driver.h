...
#define AD9833_PHASE_REG_MAX (1 << 12)    //! Max. value for the phase reg
#define AD9833_FREQ_14BIT_SHIFT 14        //! m is the current fmclk [MHz]
...
/* ---- Macros ---- */
#define HZ_TO_dHZ(x) x * 10 //! Convert from HZ to dHZ
#define GET_14_MSB(x) ((x >> 14) & 0x3FFFU) //! Get the 14 MSBs
...
ad9833_st_t ad9833_set_freq_word(uint32_t freq, reg_t reg);
