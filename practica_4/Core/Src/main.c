...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define INIT_DELAY_TIME 0 //! Delay to init the delay
...
/**
 * @brief Function to turn the led on when pressed.
 *
 * @retval None.
 */
void buttonPressed();
/**
 * @brief Function to turn the led off when released.
 *
 * @retval None.
 */
void buttonReleased();
